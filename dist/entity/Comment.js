...
var Comment = (_dec = (0, _typeorm.Entity)('comments'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('text'), _dec4 = (0, _typeorm.Column)('timestamp'), _dec5 = (0, _typeorm.Column)('timestamp'), _dec6 = (0, _typeorm.Column)('integer'), _dec7 = (0, _typeorm.Column)('integer'), _dec8 = (0, _typeorm.ManyToOne)(function () {
  return _User.User;
}, function (user) {
...
}), _dec10 = (0, _typeorm.ManyToOne)(function () {
  return _Blog.Blog;
}, function (blog) {
  ...
  name: 'blogId',
  referencedColumnName: 'id'
}), _dec(_class = (_class2 = (_temp = function Comment(data) {
  ...
  (0, _initializerDefineProperty2["default"])(this, "blogId", _descriptor6, this);
  (0, _initializerDefineProperty2["default"])(this, "user", _descriptor7, this);
  (0, _initializerDefineProperty2["default"])(this, "blog", _descriptor8, this);
  ...
  writable: true,
  initializer: null
}), _descriptor5 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "userId", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "blogId", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "user", [_dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "blog", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
