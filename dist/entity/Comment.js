...
var Comment = (_dec = (0, _typeorm.Entity)('comments'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('text'), _dec4 = (0, _typeorm.Column)('timestamp'), _dec5 = (0, _typeorm.Column)('timestamp'), _dec6 = (0, _typeorm.ManyToOne)(function () {
  return _User.User;
}, function (user) {
  ...
  (0, _initializerDefineProperty2["default"])(this, "blog", _descriptor6, this);
  ...
  writable: true,
  initializer: null
}), _descriptor6 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "blog", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
