...
// EXTERNAL MODULE: external "typeorm"
var external_typeorm_ = __webpack_require__(794);
// EXTERNAL MODULE: ./model/entity/User.ts + 1 modules
var User = __webpack_require__(809);
// EXTERNAL MODULE: ./model/entity/Post.ts
var Post = __webpack_require__(242);
// EXTERNAL MODULE: ./model/entity/Comment.ts
var Comment = __webpack_require__(174);
// EXTERNAL MODULE: ./ormconfig.js
var ormconfig = __webpack_require__(758);
var ormconfig_default = /*#__PURE__*/__webpack_require__.n(ormconfig);
;// CONCATENATED MODULE: ./model/seed.ts
...
(0,external_typeorm_.createConnection)(_objectSpread(_objectSpread({}, (ormconfig_default())), {}, {
  ...
  const comments = await connection.manager.find('comments', {
    relations: ['user', 'post']
  });
